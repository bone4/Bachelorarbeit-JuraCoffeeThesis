...
2.
Extract folder _texmf_ from tuhhslides.zip to some folder A
...
4.
Extract remaining files from tuhhslides.zip to some folder B

5a.
Open slides.tex with TeXworks. Make sure pdfLatex is chosen (top left, next to green arrow).
