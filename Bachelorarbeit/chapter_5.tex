...
Wort \wort{29} Byte 1 wird zu Beginn einer Reinigung auf \wert{65} gesetzt und am Ende auf \wert{0} zurück gesetzt.
...
In den Bytes \wort{37} bis \wort{3C}, in Byte \wort{43}, sowie in den Bytes \wort{71} bis \wort{75} befinden sich sehr wahrscheinlich interne Zählerstände, die während einer Kaffeezubereitung oder allgemeiner beim Pumpen von Wasser inkrementiert werden.
