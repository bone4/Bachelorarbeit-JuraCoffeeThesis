...
\documentclass[de,acronymlist,declaration,figurelist,tablelist,bibbacklinks,inputenc=utf8]{tuhhthesis}
...
\input{chapter_6} % Diskussion
\input{chapter_7} % Zusammenfassung und Ausblick
