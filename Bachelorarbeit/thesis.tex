...
\examinerFirst{Prof. Dr. Volker Turau}{Institute für Telematik\newline Technische Universität Hamburg}
\examinerSecond{Florian Meyer}{Institute für Telematik\newline Technische Universität Hamburg}

\supervisorFirst{Florian Meyer}{Institute für Telematik, Technische Universität Hamburg}
...
% The Chapters
\input{chapter_1} % Einführung
\input{chapter_2} % Grundlagen
% meine Arbeit deutlich vom gegebenen abgrenzen: Hard-&Software vs. meine Implementierung
\input{chapter_3} % Hardware und Software
\input{chapter_4} % Methodik und Implementierung
\input{chapter_5} % Speicher                     % Analyse / Zusammenfassung / Ergebnisse
\input{chapter_6} % Diskussion und Ausblick
