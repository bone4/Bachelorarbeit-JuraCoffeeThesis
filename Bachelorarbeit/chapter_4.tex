...
Für den \ac{EEPROM} war es hilfreich einmal systematisch durch das Handbuch der Maschine zugehen und zum Beispiel immer eine Menüoption zu variieren.
...
% EEPROM und RAM Klasse unterscheiden sich durch Größe und Kaffee Komando in der *.hpp.

% Hauptdatei AnalyseFileDumpsMenu-Funktion: An JSON Datei nicht ersichtlich ob EEPROM oder RAM, daher von Hand in Zeile 192 für den RAM die Zeilen zum exkludieren setzen

% serial connection: blocken aller anderen Prozesse
